# Primes sum
## Easy
<div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number N. Find if it can be expressed as sum of two prime numbers.</span><br>
<br>
